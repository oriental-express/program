...
function sub(){
  ...
  <body>
    <form action="payOutUpdate" method="post" name="payOut_update" id="payOut_update">
<table width="99%" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="89%" class="tr_s"><input name="payOutName" type="text" id="payOutName" size="30" value="<s:property value="payOut.payOutName"/>"/>
      <span class="mark">*</span></td>
  </tr>
  <tr>
    <td class="tr_s">支出金额:</td>
    <td class="tr_s"><input type="text" name="payOutMoney" id="payOutMoney" size="30" value="<s:property value="payOut.payOutMoney"/>"/>
      <span class="mark">*</span></td>
  </tr>
  <tr>
    <td class="tr_s">支出日期:</td>
    <td class="tr_s"><input type="text" name="payOutDate" id="payOutDate" size="30" onclick="return showCalendar('payOutDate', 'y-mm-dd');" value="<s:property value="payOut.payOutDate"/>"/>
      <span class="mark">*</span></td>
  </tr>
  <tr>
    <td colspan="2" class="tr_s">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input name="submit" type="submit" class="btn" id="submit" value="修改" onclick="return sub()"/>
	<input type="hidden" name="id" id="id" value="<s:property value="payOut.id" />"/>
