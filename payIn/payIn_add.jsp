...
function sub(){
  ...
  <body>
    <form action="payInAdd" method="post" name="payIn_add" id="payIn_add">
<table width="99%" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" class="title_s">收入添加</td>
  </tr>
  <tr>
    <td width="10%" class="tr_s">收入名称:</td>
    <td width="89%" class="tr_s"><input name="payInName" type="text" id="payInName" size="30"/>
      <span class="mark">*</span></td>
  </tr>
  <tr>
    <td class="tr_s">收入金额:</td>
    <td class="tr_s"><input type="text" name="payInMoney" id="payInMoney" size="30"/>
      <span class="mark">*</span></td>
  </tr>
  <tr>
    <td class="tr_s">收入日期:</td>
       <td class="tr_s"><input type="text" name="payInDate" id="payInDate" size="30" onclick="return showCalendar('payInDate', 'y-mm-dd');"/>
      <span class="mark">*</span></td>
  </tr>
  <tr>
